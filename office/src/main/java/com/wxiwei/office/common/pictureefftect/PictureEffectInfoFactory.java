...
public class PictureEffectInfoFactory
{
    ...
    public static PictureEffectInfo getPictureEffectInfor(Element blipFill)
    {
        ...
        if(e != null)
        {
            ...
            if(value != null)
            {
                left = IntegerTool.parseIntWithoutException(value) / 100000f;
            }
            ...
            if(value != null)
            {
                top = IntegerTool.parseIntWithoutException(value) / 100000f;
            }
            ...
            if(value != null)
            {
                right = IntegerTool.parseIntWithoutException(value) / 100000f;
            }
            ...
            if(value != null)
            {
                bottom = IntegerTool.parseIntWithoutException(value) / 100000f;
            }
        ...
        if(e != null)
        {
            ...
            {
                validateInfor = true;
                effectInfor.setBlackWhiteThreshold(IntegerTool.parseIntWithoutException(value) / 100000f * 255);
            }
        }
        ...
        if(e != null)
        {
            ...
            {
                validateInfor = true;
                float b= IntegerTool.parseIntWithoutException(value) / 100000f;
            ...
            {
                validateInfor = true;
                float c= IntegerTool.parseIntWithoutException(value) / 100000f;
                if(c > 0)
                {
    ...
    public static PictureEffectInfo getPictureEffectInfor_ImageData(Element imagedata)
    {
    	if(imagedata != null)
    	{
    		...
    		if(value != null)
            {
                left = FloatTool.parseFloatWithoutException(value) / 65535;
            }
    		...
    		if(value != null)
            {
                top = FloatTool.parseFloatWithoutException(value) / 65535;
            }
    		...
    		if(value != null)
            {
                right = FloatTool.parseFloatWithoutException(value) / 65535;
            }
    		...
    		if(value != null)
            {
    			bottom = FloatTool.parseFloatWithoutException(value) / 65535;
            }
    		...
    		if(value != null)
            {
                ...
                if(value.contains("f"))
                {
                	blacklevel = FloatTool.parseFloatWithoutException(value) / 65535 * 2;
                }
                else
                {
                	blacklevel = FloatTool.parseFloatWithoutException(value) * 2;
                }
    		...
    		if(value != null)
            {
                ...
                if(value.contains("f"))
                {
                	gain = FloatTool.parseFloatWithoutException(value) / 65535;
                }
                else
                {
                	gain = FloatTool.parseFloatWithoutException(value);
                }
