...
//            }
        ...
        float endX, float endY, float fU)
   {
    ...
    {
    	float x = IntegerTool.parseIntWithoutException(head.attributeValue("x")) * MainConstant.PIXEL_DPI / MainConstant.EMU_PER_INCH;
    	float y = IntegerTool.parseIntWithoutException(head.attributeValue("y"))* MainConstant.PIXEL_DPI / MainConstant.EMU_PER_INCH;
