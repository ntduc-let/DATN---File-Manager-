...
public class ListKit
{
	...
	private String zr4(String y)
	{
		...
		z[8] = "eight";
		z[9] = "nine";
		return z[IntegerTool.parseIntWithoutException(y.substring(0, 1))];
	}
	...
	private String zr3(String y)
	{
		...
		z[8] = "eight";
		z[9] = "nine";
		return z[IntegerTool.parseIntWithoutException(y.substring(2, 3))];
	}
	...
	private String zr2(String y)
	{
		...
		z[18] = "eighteen";
		z[19] = "nineteen";
		return z[IntegerTool.parseIntWithoutException(y.substring(1, 3))];
	}
	...
	private String zr1(String y)
	{
		...
		z[8] = "eighty";
		z[9] = "ninety";
		return z[IntegerTool.parseIntWithoutException(y.substring(1, 2))];
	}
	...
	private String dw(String y)
	{
		...
		z[2] = "million";
		z[3] = "billion";
		return z[IntegerTool.parseIntWithoutException(y)];
	}
