...
public class AutoShapeDataKit
{
    ...
    public static int getColor(Map<String, Integer> schemeColor, Element solidFillElement)
    {
        ...
        {
            int r = IntegerTool.parseIntWithoutException(clr.attributeValue("r")) * 255 / 100;
            int g = IntegerTool.parseIntWithoutException(clr.attributeValue("g")) * 255 / 100;
            int b = IntegerTool.parseIntWithoutException(clr.attributeValue("b")) * 255 / 100;
                                ...
                                {  
                                	...
                                	if(tile == null)
                                	{
                                		...
                                		if(stretch != null)
                                		{
                                			...
                                			if(fillRect != null)
                                			{
                                    			...
                                    			{
                                    				validate = true;
                                    				stretchInfo.setLeftOffset(FloatTool.parseFloatWithoutException(str) / 100000);
                                    			}
                                    			...
                                    			{
                                    				validate = true;
                                    				stretchInfo.setRightOffset(FloatTool.parseFloatWithoutException(str) / 100000);
                                    			}
                                    			...
                                    			{
                                    				validate = true;
                                    				stretchInfo.setTopOffset(FloatTool.parseFloatWithoutException(str) / 100000);
                                    			}
                                    			...
                                    			{
                                    				validate = true;
                                    				stretchInfo.setBottomOffset(FloatTool.parseFloatWithoutException(str) / 100000);
                                    			}
                                	...
                                	else
                                	{
                                		...
                                		if(alphaModFix != null)
                                		{
                                			...
                                			if(amt != null)
                                			{
                                				tileShader.setAlpha(Math.round(IntegerTool.parseIntWithoutException(amt) / 100000.f * 255));
                                			}
                                		}
                ...
                if (avLst != null)
                {
                    ...
                    if (gds.size() > 0)
                    {
                        ...
                        for (int i = 0; i < gds.size(); i++)
                        {
                            ...
                            val = val.substring(4);
                            values[i] = FloatTool.parseFloatWithoutException(val) / 100000;
                        }
                    }
                }
            }
