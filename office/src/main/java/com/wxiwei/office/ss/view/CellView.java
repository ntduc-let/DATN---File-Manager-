...
//      paint.setColor(color);
    ...
    {   
        ...
        int e = IntegerTool.parseIntWithoutException(endPart);
        if(e > 0)
        {
            if(e < 10)
            {
    ...
    private String ceilNumeric(String contents)
    {
        ...
        if(index > 0)
        {
            ...
            {
                contents = String.valueOf((int)DoubleTool.parseDoubleWithoutException(contents) + 1);
            } 
        }
    ...
    private String getNonScientificGeneralContents(String contents, Paint paint)
    {
        ...
        if(textWidth + 2 * SSConstant.SHEET_SPACETOBORDER > mergedCellSize.getWidth())
        {
            ...
            value = DoubleTool.parseDoubleWithoutException(contents);
            //
    ...
    private String scientificToNormal(String contents)
    {
        ...
        //end part of contents
        int endPart = IntegerTool.parseIntWithoutException(contents.substring(index + 1));
        boolean negative = DoubleTool.parseDoubleWithoutException(firstPart) < 0;
