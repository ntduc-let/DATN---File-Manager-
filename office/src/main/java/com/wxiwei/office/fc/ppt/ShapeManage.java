...
{   
        ...
        Element sp, GroupShape parent, float zoomX, float zoomY) throws Exception
    {
        ...
        else if (name.equals("grpSp"))
        {
            ...
            {
                grpShapeID = IntegerTool.parseIntWithoutException(e.attributeValue("id"));
            }
        ...
        GroupShape parent, float zoomX, float zoomY, boolean addShape) throws Exception
    {
        ...
        id = IntegerTool.parseIntWithoutException(temp.attributeValue("id"));
        ...
        PGLayout pgLayout, PGSlide pgSlide, Element sp, GroupShape parent, float zoomX, float zoomY) throws Exception
    {
        ...
        if(e != null && (e = e.element("cNvPr")) != null)
        {
            shapeID = IntegerTool.parseIntWithoutException(e.attributeValue("id"));
        }
...
//                            	}
        ...
        PGLayout pgLayout, PGSlide pgSlide, Element sp, GroupShape parent, float zoomX, float zoomY) throws Exception
    {
        ...
        {
            shapeId = IntegerTool.parseIntWithoutException(nvGraphicFramePr.attributeValue("id"));
        }
    ...
    {   
        try
        {
            if (graphicData != null)
            {
                ...
                int id = IntegerTool.parseIntWithoutException(cs.substring("rId".length()));
                if (cs != null)
                {
