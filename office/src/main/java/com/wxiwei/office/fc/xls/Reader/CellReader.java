...
public class CellReader
{
    ...
    {        
        ...
        {
            try {
                int styleIndex = IntegerTool.parseIntWithoutException(cellElement.attributeValue("s"));
    ...
    public  Cell getCell(Sheet sheet, Element cellElement)
    {
        ...
        {
            try {
                styleIndex = IntegerTool.parseIntWithoutException(cellElement.attributeValue("s"));
            } catch (Exception ignored) {
            }
        }
        else
        ...
        if(v != null)
        {
            ...
            {
                int sstIndex = IntegerTool.parseIntWithoutException(value);
            ...
            {
                cell.setCellValue(DoubleTool.parseDoubleWithoutException(value));
            }
            else if(cellType ==CELLTYPE_BOOLEAN)
            {
                cell.setCellValue(IntegerTool.parseIntWithoutException(value) != 0);
            }
            else
            {
