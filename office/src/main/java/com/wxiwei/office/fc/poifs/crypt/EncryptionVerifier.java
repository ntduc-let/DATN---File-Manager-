...
public class EncryptionVerifier {
    ...
    public EncryptionVerifier(String descriptor) {
        ...
        spinCount = IntegerTool.parseIntWithoutException(keyData.getNamedItem("spinCount")
                                     .getNodeValue());
        ...
        int saltSize = IntegerTool.parseIntWithoutException(keyData.getNamedItem("saltSize")
                                        .getNodeValue());
        ...
        int blockSize = IntegerTool.parseIntWithoutException(keyData.getNamedItem("blockSize")
                                         .getNodeValue());
        ...
        verifierHashSize = IntegerTool.parseIntWithoutException(keyData.getNamedItem("hashSize")
                                            .getNodeValue());
    }
