...
public class ImageUtils
{
    ...
    /*public static int[] getResolution(ImageReader r) throws IOException
    {
        ...
        if (lst != null && lst.getLength() == 1)
            hdpi = (int)(mm2inch / FloatTool.parseFloatWithoutException(((Element)lst.item(0)).getAttribute("value")));

        lst = node.getElementsByTagName("VerticalPixelSize");
        if (lst != null && lst.getLength() == 1)
            vdpi = (int)(mm2inch / FloatTool.parseFloatWithoutException(((Element)lst.item(0)).getAttribute("value")));
