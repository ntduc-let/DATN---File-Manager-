...
public class ParaAttr
{
        ...
        SectionElement secElem, Element styleElement, Element txBody, String type, int idx)
    {
        ...
        if (bodyPr != null)
        {
            ...
            if (normAutofit != null)
            {
                if (normAutofit.attribute("fontScale") != null)
                {
                    ...
                    {
                        fontScale = IntegerTool.parseIntWithoutException(val) / 1000;
                    }
                }
        ...
        {   
            ...
            if (pPr != null && pPr.attribute("lvl") != null)
            {
                ...
                if (val != null && val.length() > 0)
                {
                    lvl += IntegerTool.parseIntWithoutException(val);
                }
            }
            int layoutStyle = -1;
            if (pgLayout != null)
        ...
        int layoutStyle, int masterStyle, int lnSpcReduction, boolean addBullet, boolean subTitle)
    {
                ...
                if (temp != null && temp.attribute("val") != null)
                {
                    ...
                    if (val != null && val.length() > 0)
                    {
                        AttrManage.instance().setParaBefore(attr, 
                            (int)(IntegerTool.parseIntWithoutException(val) / 100 * MainConstant.POINT_TO_TWIPS));
                    }
                }
            }
            else
            ...
            if (lnSpc != null)
            {
                ...
                if (temp != null && temp.attribute("val") != null)
                {
                    ...
                    if (val != null && val.length() > 0)
                    {
                        ...
                        // 行距
                        AttrManage.instance().setParaLineSpace(attr, (float)(IntegerTool.parseIntWithoutException(val) - lnSpcReduction) / 100000);
                    }
                }
            }
            else
            ...
            if (pPr.attribute("marR") != null)
            {
                ...
                if (val != null && val.length() > 0)
                {
                    AttrManage.instance().setParaIndentRight(attr, 
                        (int)(IntegerTool.parseIntWithoutException(val) * MainConstant.POINT_DPI / MainConstant.EMU_PER_INCH
        ...
        if (pPr != null && pPr.attribute("marL") != null)
        {
            ...
            if (val != null && val.length() > 0)
            {
                left = (int)(IntegerTool.parseIntWithoutException(val) * MainConstant.POINT_DPI / MainConstant.EMU_PER_INCH
                    * MainConstant.POINT_TO_TWIPS);
        ...
        if (pPr != null && pPr.attribute("indent") != null)
        {
            ...
            if (val != null && val.length() > 0)
            {
                indent = (int)(IntegerTool.parseIntWithoutException(val)* MainConstant.POINT_DPI / MainConstant.EMU_PER_INCH
                    * MainConstant.POINT_TO_TWIPS);
        ...
        { 
            ...
            if (spcBef != null)
            {
                ...
                if (temp != null && temp.attribute("val") != null)
                {
                    ...
                    {
                        AttrManage.instance().setParaBefore(attr, 
                            (int)(IntegerTool.parseIntWithoutException(val) / 100000.f * fontSize * POINT_PER_LINE_PER_FONTSIZE * MainConstant.POINT_TO_TWIPS));
                    }
                }
            }
