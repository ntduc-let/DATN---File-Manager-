...
public class RunAttr
{
        ...
        int fontScale, int styleID, boolean newLine)
    {
        if (rPr != null)
        {
            ...
            if (rPr.attribute("sz") != null)
            {
                ...
                {
                    AttrManage.instance().setFontSize(attr, (int)(FloatTool.parseFloatWithoutException(val) / 100));
                }
            }
            else
            {
            ...
            if (!newLine)
            {
                ...
                if (rPr.attribute("i") != null)
                {
                    ...
                    if (val != null && val.length() > 0)
                    {
                        AttrManage.instance().setFontItalic(attr, IntegerTool.parseIntWithoutException(val) > 0);
                    }
                }
                else
                {
                ...
                if (rPr.attribute("baseline") != null)
                {
                    ...
                    if (val != null && val.length() > 0)
                    {
                        int value = IntegerTool.parseIntWithoutException(val);
                        if (value != 0)
                        {
    ...
    private int getRunPropColor(Workbook book, Element clr)
    {
        ...
        if(clr.attributeValue("indexed") != null)
        {
            ...
            color = book.getColor(IntegerTool.parseIntWithoutException(val));
        }
        else if(clr.attributeValue("theme") != null)
        {
            val = clr.attributeValue("theme");
            //get scheme color
            color = SchemeColorUtil.getThemeColor(book, IntegerTool.parseIntWithoutException(val));
        }
        ...
        {
            double tint = DoubleTool.parseDoubleWithoutException(clr.attributeValue("tint"));
    ...
    public int getColor(Workbook book, Element solidFillElement)
    {
        ...
        else if(solidFillElement.element("schemeClr") != null)
        {
            ...
            if (clr.element("tint") != null)
            {
                color = ColorUtil.instance().getColorWithTint(color, 
                    IntegerTool.parseIntWithoutException(clr.element("tint").attributeValue("val")) / 100000.0);
            }
            else if (clr.element("lumOff") != null)
            {
                color = ColorUtil.instance().getColorWithTint(color, 
                    IntegerTool.parseIntWithoutException(clr.element("lumOff").attributeValue("val")) / 100000.0);
            }
            else if (clr.element("lumMod") != null)
            {
                color = ColorUtil.instance().getColorWithTint(color, 
                    IntegerTool.parseIntWithoutException(clr.element("lumMod").attributeValue("val")) / 100000.0 - 1);
            }
            else if (clr.element("shade") != null)
            {
                color = ColorUtil.instance().getColorWithTint(color, 
                    -IntegerTool.parseIntWithoutException(clr.element("shade").attributeValue("val")) / 200000.0);
            }
        ...
        else if(solidFillElement.element("sysClr") != null)
        {
            ...
            //get system color
            color = IntegerTool.parseIntWithoutException( clr.attributeValue("lastClr"), 16);
            color = (0xFF << 24) | color;
        }
        return color;
    }
    ...
    public void setRunAttribute(Sheet sheet, Element rPr, IAttributeSet attr, IAttributeSet attrLayout)
    {
        if (rPr != null)
        {
            ...
            if (rPr.attribute("b") != null)
            {
                AttrManage.instance().setFontBold(attr, IntegerTool.parseIntWithoutException(rPr.attributeValue("b")) == 1 ? true : false);
            }
            else
            {
                setFontBold(attrLayout, attr);
            ...
            if (rPr.attribute("i") != null)
            {
                AttrManage.instance().setFontItalic(attr, IntegerTool.parseIntWithoutException(rPr.attributeValue("i")) == 1 ? true : false);
            }
            else
            {
                setFontItalic(attrLayout, attr);
            ...
            if (rPr.attribute("baseline") != null)
            {
                ...
                {
                    AttrManage.instance().setFontScript(attr, IntegerTool.parseIntWithoutException(val) > 0 ? 1 : 2);
                }
            }
            else
            {
...
//           Font font = book.getFont(fontID);
           ...
           if (temp != null)
           {
               ...
               if (val != null && val.length() > 0)
               {
                   AttrManage.instance().setFontSize(attr, (int)FloatTool.parseFloatWithoutException(val));
               }
           }
           else
           {
