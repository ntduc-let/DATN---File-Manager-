...
{    
    ...
    private AnchorPoint getCellAnchor(Element cellAnchorElement)
    {
        ...
        int val = IntegerTool.parseIntWithoutException(ele.getText());
        ...
        val = IntegerTool.parseIntWithoutException(ele.getText());
    ...
    private static Font getFont(Element rPr)
    {
        ...
        {
            font.setFontSize(IntegerTool.parseIntWithoutException(rPr.attributeValue("sz")) / 100);
        }        
        
        //bold
        if(rPr.attributeValue("b") != null 
            && IntegerTool.parseIntWithoutException(rPr.attributeValue("b")) != 0)
        {
            font.setBold(true);
        }
        ...
        if(rPr.attributeValue("i") != null 
            && IntegerTool.parseIntWithoutException(rPr.attributeValue("i")) != 0)
        {
            font.setItalic(true);
        }
