...
public class EncryptionHeader {
    ...
    public EncryptionHeader(String descriptor) throws IOException {
        ...
        keySize = IntegerTool.parseIntWithoutException(keyData.getNamedItem("keyBits")
                                   .getNodeValue());
        flags = 0;
        sizeExtra = 0;
        cspName = null;
        ...
        int hashSize = IntegerTool.parseIntWithoutException(keyData.getNamedItem("hashSize")
                                        .getNodeValue());
        ...
        int saltLength = IntegerTool.parseIntWithoutException(keyData.getNamedItem("saltSize")
                                          .getNodeValue());
