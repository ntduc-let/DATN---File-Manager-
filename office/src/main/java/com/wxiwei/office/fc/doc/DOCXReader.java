...
public class DOCXReader extends AbstractReader
{
        ...
        if (styleRel != null)
        {
            ...
            if (part != null)
            {
                ...
                for (Element styleEle : styles)
                {
                    ...
                    if (val != null)
                    {
                        //style.setId(IntegerTool.parseIntWithoutException(val, 16));
        ...
        if (styleRel != null)
        {
            ...
            if (part != null)
            {
                ...
                for (Element num : nums)
                {
                    ...
                    {
                        listData.setListID(IntegerTool.parseIntWithoutException(abstractNumId));
                    }
                    // list level
                        ...
                        if (styleLink != null)
                        {
                            ...
                            if (styleID != null)
                            {
                                ...
                                if (a != null)
                                {
                                    ...
                                    if (styleListNumID >= 0)
                                    {
                                        styleListNumID = IntegerTool.parseIntWithoutException(bulletNumbersID.get(String.valueOf(styleListNumID)));
    ...
    private void processListLevel(ListLevel level, Element elem)
    {
        ...
        if (temp != null)
        {
            level.setStartAt(IntegerTool.parseIntWithoutException(temp.attributeValue("val")));
        }        
        ...
        if (temp != null)
        {
            ...
            for (int i = 0; i < val.length(); i++)
            {
                ...
                if (c == '%')
                {
                    int a = IntegerTool.parseIntWithoutException(val.substring(i + 1, i + 2));
                    sb.append((char)(a - 1));
                    i++;
                }
                else
        ...
        if (temp != null)
        {
            ...
            if (temp != null)
            {
                ...
                if (val != null)
                {
                    level.setSpecialIndent(-IntegerTool.parseIntWithoutException(val));
                }            
                // left text indent, default 21 point * level
                val = temp.attributeValue("left");
                if (val != null)
                {
                    level.setTextIndent(IntegerTool.parseIntWithoutException(val));
                }
            }
        }
    }
    ...
    private void processSectionAttribute(Element sectPr)
    {
        ...
        if (pgSz != null)
        {
            ...
            AttrManage.instance().setPageWidth(attr,
                IntegerTool.parseIntWithoutException(pgSz.attributeValue("w")));
            // 高度
            AttrManage.instance().setPageHeight(attr,
                IntegerTool.parseIntWithoutException(pgSz.attributeValue("h")));
        }
        // 边距 
        ...
        if (margin != null)
        {
            ...
            AttrManage.instance().setPageMarginLeft(attr,
                IntegerTool.parseIntWithoutException(margin.attributeValue("left")));
            // 右边距
            AttrManage.instance().setPageMarginRight(attr,
                IntegerTool.parseIntWithoutException(margin.attributeValue("right")));
            // 上边距
            AttrManage.instance().setPageMarginTop(attr,
                IntegerTool.parseIntWithoutException(margin.attributeValue("top")));
            // 下边距
            AttrManage.instance().setPageMarginBottom(attr,
                IntegerTool.parseIntWithoutException(margin.attributeValue("bottom")));
            // 页眉边距
            if (margin.attributeValue("header") != null)
            {
                AttrManage.instance().setPageHeaderMargin(attr,
                    IntegerTool.parseIntWithoutException(margin.attributeValue("header")));
            }
            // 页脚边距
            if (margin.attributeValue("footer") != null)
            {
                AttrManage.instance().setPageFooterMargin(attr,
                    IntegerTool.parseIntWithoutException(margin.attributeValue("footer")));
            }
        }
        // page border
        ...
        if(docGrid != null)
        {
        	...
        	if("lines".equals(type) || "linesAndChars".equals(type) || "snapToChars".equals(type))
        	{
        		...
        		{        			
        			AttrManage.instance().setPageLinePitch(attr, IntegerTool.parseIntWithoutException(linePitch));
    ...
    private void processBorder(Element borElem, Border border)
    {
        ...
        {
            border.setSpace((short)(IntegerTool.parseIntWithoutException(value) * MainConstant.POINT_TO_PIXEL));
        }
    }
    ...
    private void processTable(Element table)
    {
        ...
        if (tblGrid != null)
        {
            ...
            if (grids != null)
            {
                ...
                {
                    tableGridCol.put(i, IntegerTool.parseIntWithoutException(grids.get(i).attributeValue("w")));
                }
            }
        }
    ...
    private void processTableAttribute(Element tblPr, IAttributeSet attr)
    {
        ...
        if (temp != null)
        {
            ...
            if (val != null)
            {
                AttrManage.instance().setParaIndentLeft(attr, IntegerTool.parseIntWithoutException(val));
            }
        }
    ...
    private void processRowAttribute(Element trPr, IAttributeSet attr)
    {
        ...
        if (temp != null)
        {
            AttrManage.instance().setTableRowHeight(attr, 
                IntegerTool.parseIntWithoutException(temp.attributeValue("val")));
        }
    }
    ...
    private int processCellAttribute(Element tcPr, IAttributeSet attr, int gridColIndex)
    {
        ...
        if (temp != null)
        {
            gridSpan = IntegerTool.parseIntWithoutException(temp.attributeValue("val"));
        }
        // 宽度
        temp = tcPr.element("tcW");
        if (temp != null)
        {
            int w = IntegerTool.parseIntWithoutException(temp.attributeValue("w"));
    ...
    private void processParaAttribute(Element pPr, IAttributeSet attr, int level)
    {
     ...
     // 样式
        ...
        if (temp != null)
        {
            ...
            if (val != null)
            {
                int lineUnit = IntegerTool.parseIntWithoutException(val);
                // 默认行单位是12磅
                ...
                if (val != null && val.length() > 0)
                {
                    AttrManage.instance().setParaBefore(attr, (int)(IntegerTool.parseIntWithoutException(val) / 100.f * lineUnit));
                }
                if (val == null)
                {
                    // 段前
                    ...
                    if (val != null && val.length() > 0)
                    {
                        AttrManage.instance().setParaBefore(attr, IntegerTool.parseIntWithoutException(val));
                    }
                }
                // 段后
                ...
                if (val != null && val.length() > 0)
                {
                    AttrManage.instance().setParaAfter(attr, (int)(IntegerTool.parseIntWithoutException(val) / 100.f * lineUnit));
                }
                if (val == null)
                {
                    // 段后
                    ...
                    if (val != null && val.length() > 0)
                    {
                        AttrManage.instance().setParaAfter(attr, IntegerTool.parseIntWithoutException(val));
                    }
                }
            }
            // 非单位
            else
            {
                ...
                else
                {
                	...
                	if(val != null && val.length() > 0)
                	{
                		AttrManage.instance().setParaBefore(attr, (int)(IntegerTool.parseIntWithoutException(val) / 100.f * 240));
                	}
                }
                ...
                else
                {
                	...
                	if(val != null && val.length() > 0)
                	{
                		AttrManage.instance().setParaAfter(attr, (int)(IntegerTool.parseIntWithoutException(val) / 100.f * 240));
                	}
                }
            }
            // 行距
            ...
            {
                lineSpace = FloatTool.parseFloatWithoutException(temp.attributeValue("line"));
            }
            // 多倍行距
            if ("auto".equals(val))
            {
        ...
        if (temp != null)
        {
            ...
            {
            	float leftChars = IntegerTool.parseIntWithoutException(val) / 100f;
            ...
            else if((val = temp.attributeValue("left")) != null)
            {
            	if (val != null && val.length() > 0)
                {
                    left = IntegerTool.parseIntWithoutException(val);
            ...
            if(val != null && val.length() > 0 && !val.equals("0"))
            {
            	float rightChars = IntegerTool.parseIntWithoutException(val) / 100f;
            ...
            else if((val = temp.attributeValue("right")) != null)
            {
            	if (val != null && val.length() > 0)
                {
                    AttrManage.instance().setParaIndentRight(attr, IntegerTool.parseIntWithoutException(val));
                }
            }
            ...
            if(val != null && val.length() > 0 && !val.equals("0"))
            {
            	float firstLineChars = IntegerTool.parseIntWithoutException(val) / 100f;
            ...
            else if((val = temp.attributeValue("firstLine")) != null)
            {
            	if (val != null && val.length() > 0)
            	{
            		AttrManage.instance().setParaSpecialIndent(attr, IntegerTool.parseIntWithoutException(val));
            	}
            ...
            if(val != null && val.length() > 0 && !val.equals("0"))
            {
            	float hangingChars = IntegerTool.parseIntWithoutException(val) / 100f;
            ...
            else if((val = temp.attributeValue("hanging")) != null)
            {
            	if (val != null && val.length() > 0)
                {
                    int sp = -IntegerTool.parseIntWithoutException(val);
        ...
        if (temp != null)
        {
            ...
            if (t != null)
            {
                AttrManage.instance().setParaListLevel(attr, IntegerTool.parseIntWithoutException(t.attributeValue("val")));
            }            
            // list ID
            ...
            if (t != null)
            {
                ...
                if (val != null)
                {
                    ...
                    if (bnID != null)
                    {
                        AttrManage.instance().setParaListID(attr, IntegerTool.parseIntWithoutException(bnID));
                    }
                    else
                    {
                        //AttrManage.instance().setParaListID(attr, IntegerTool.parseIntWithoutException(val));
                    }
                }                
            }
        }
            ...
            if (tabs != null)
            {
                for (Element tab : tabs)
                {
                    if ("clear".equals(tab.attributeValue("val")))
                    {
                        ...
                        if (val != null && val.length() > 0)
                        {
                            AttrManage.instance().setParaTabsClearPostion(attr, IntegerTool.parseIntWithoutException(val));
                        }
                    }
                }
            }
...
//                        hasField = false;
    ...
    private void processWrapAndPosition_Drawing(WPAbstractShape shape, Element anchor, Rectangle rect)
    {
        ...
        if(positionHElement !=  null)
        {
            ...
            {
            	rect.translate(Math.round(IntegerTool.parseIntWithoutException(positionHElement.element("posOffset").getText())
            ...
            else if(positionHElement.element("pctPosHOffset") != null)
            {
            	...
            	shape.setHorRelativeValue(IntegerTool.parseIntWithoutException(positionHElement.element("pctPosHOffset").getText()) / 100);
        ...
        if(positionVElement !=  null)
        {
            ...
            {
            	rect.translate(0, Math.round(IntegerTool.parseIntWithoutException(positionVElement.element("posOffset").getText())
                        * MainConstant.PIXEL_DPI / MainConstant.EMU_PER_INCH));
            }
            else if(positionVElement.element("pctPosVOffset") != null)
            {
            	shape.setVerRelativeValue(IntegerTool.parseIntWithoutException(positionVElement.element("pctPosVOffset").getText()) / 100);
                ...
                if (graphicdata != null)
                {
                                ...
                                try
                                {
                                    ...
                                    if (abstrChart != null)
                                    {
                                    	...
                                    	if(simplePos != null)
                                    	{
                                    		...
                                    		if(x != null)
                                    		{
                                    			bounds.x = (int)(IntegerTool.parseIntWithoutException(x) * MainConstant.PIXEL_DPI / MainConstant.EMU_PER_INCH);
                                    		}
                                    		
                                    		String y = simplePos.attributeValue("y");
                                    		if(y != null)
                                    		{
                                    			bounds.y = (int)(IntegerTool.parseIntWithoutException(y) * MainConstant.PIXEL_DPI / MainConstant.EMU_PER_INCH);
                                    		}
                                    	}
                                    	...
                                    	if(extent != null)
                                    	{
                                    		...
                                    		if(cx != null)
                                    		{
                                    			bounds.width = (int)(IntegerTool.parseIntWithoutException(cx) * MainConstant.PIXEL_DPI / MainConstant.EMU_PER_INCH);
                                    		}
                                    		
                                    		String cy = extent.attributeValue("cy");
                                    		if(cy != null)
                                    		{
                                    			bounds.height = (int)(IntegerTool.parseIntWithoutException(cy) * MainConstant.PIXEL_DPI / MainConstant.EMU_PER_INCH);
                                    		}
                                    	}
                    ...
                    else if(graphicdata.element("relIds") != null)
                    {
                        ...
                        { 
                            ...
                            {
//                                val = val.substring(3);
//                                int a = IntegerTool.parseIntWithoutException(val);
                                    ...
                                    if (diagramRel != null)
                                    {
                                        ...
                                        if (extent != null)
                                        {
                                            if (extent.attribute("cx") != null)
                                            {
                                                ...
                                                if (val != null && val.length() > 0)
                                                {
                                                    rect.width = (int)(IntegerTool.parseIntWithoutException(val) * MainConstant.PIXEL_DPI / MainConstant.EMU_PER_INCH);
                                                }
                                            }
                                            if (extent.attribute("cy") != null)
                                            {
                                                ...
                                                if (val != null && val.length() > 0)
                                                {
                                                    rect.height = (int)(IntegerTool.parseIntWithoutException(val) * MainConstant.PIXEL_DPI / MainConstant.EMU_PER_INCH);
                                                }
                                            }
                                        }
                    ...
                    if (temp != null && temp.length() > 0)
                    {
                        ...
                        if (values != null)
                        {
                        	if(values.length == 2)
                        	{
                            	...
                            	{
                            		x = FloatTool.parseFloatWithoutException(values[0]);
                            	}                            
                                y = FloatTool.parseFloatWithoutException(values[1]);
                        	}
                    ...
                    if (temp != null && temp.length() > 0)
                    {
                        ...
                        if (values != null)
                        {
                        	if(values.length == 2)
                        	{
                        		if(values[0].length() > 0)
                        		{
                        			w = FloatTool.parseFloatWithoutException(values[0]);
                        		}                        		
                                h = FloatTool.parseFloatWithoutException(values[1]);
                        	}
                        	else if(values.length == 1)
                        	{
                        		w = FloatTool.parseFloatWithoutException(values[0]);
...
//        else
        {
            ...
            if(style != null)
            {
                ...
                for (int i = styles.length - 1; i >= 0; i--)
                {
                    ...
                    {
                        int zIndex = IntegerTool.parseIntWithoutException(styles[i].replace("z-index:", ""));
                        if(zIndex > 0)
                        {
                    ...
                    if (picPart != null && style != null)
                    {
                        ...
                        try
                        {
                            ...
                            if (isProcessWatermark)
                            {
                           	 	...
                           	 	if(blacklevel != null)
                           	 	{
                           	 		((WatermarkShape)abstractShape).setBlacklevel(FloatTool.parseFloatWithoutException(blacklevel) / 100000f);
                           	 	}
                           	 	String gain = imagedata.attributeValue("gain");
                           	 	if(gain != null)
                           	 	{
                           	 		((WatermarkShape)abstractShape).setGain(FloatTool.parseFloatWithoutException(gain) / 100000f);
                           	 	}
                ...
                if (styleStr != null)
                {
                    ...
                    for (int i = 0; i < styles.length; i++)
                    {
                        ...
                        if (temps != null && temps[0] != null && temps[1] != null)
                        {
                            if ("left".equalsIgnoreCase(temps[0]))
                            {
                                ...
                                if (index > 0)
                                {
                                    x += FloatTool.parseFloatWithoutException(temps[1].substring(0, index));
                                }
                                else
                                {
                                    ...
                                    if (index > 0)
                                    {
                                        x += FloatTool.parseFloatWithoutException(temps[1].substring(0, index)) * MainConstant.POINT_DPI;
                                    }
                                    else
                                    {
                                        x += FloatTool.parseFloatWithoutException(temps[1]) * zoomX * MainConstant.POINT_DPI / MainConstant.EMU_PER_INCH;
                                    }
                                }
                            }
                            else if ("top".equalsIgnoreCase(temps[0]))
                            {
                                ...
                                if (index > 0)
                                {
                                    y += FloatTool.parseFloatWithoutException(temps[1].substring(0, index));
                                }
                                else
                                {
                                    index = temps[1].indexOf("in");
                                    if (index > 0)
                                    {
                                        y += FloatTool.parseFloatWithoutException(temps[1].substring(0, index)) * MainConstant.POINT_DPI;
                                    }
                                    else
                                    {
                                        y += FloatTool.parseFloatWithoutException(temps[1]) * zoomY * MainConstant.POINT_DPI / MainConstant.EMU_PER_INCH;
                                    }
                                }
                            }
                            else if ("margin-left".equalsIgnoreCase(temps[0]))
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        x += FloatTool.parseFloatWithoutException(temps[1]) * MainConstant.POINT_DPI / MainConstant.EMU_PER_INCH;
                                    }
                                }
                            }
                            ...
                            {                                
                                ...
                                else
                                {
                                    ...
                                    {
                                        y += FloatTool.parseFloatWithoutException(temps[1]) * MainConstant.POINT_DPI / MainConstant.EMU_PER_INCH;
                                    }
                                }
                            }
                            else if ("width".equalsIgnoreCase(temps[0]))
                            {
                                ...
                                if (index > 0)
                                {
                                    w = FloatTool.parseFloatWithoutException(temps[1].substring(0, index));
                                }
                                else
                                {
                                    index = temps[1].indexOf("in");
                                    if (index > 0)
                                    {
                                        w = FloatTool.parseFloatWithoutException(temps[1].substring(0, index)) * MainConstant.POINT_DPI;
                                    }
                                    else
                                    {
                                        w = FloatTool.parseFloatWithoutException(temps[1]) * zoomX * MainConstant.POINT_DPI / MainConstant.EMU_PER_INCH;
                                    }
                                }
                            }
                            else if ("height".equalsIgnoreCase(temps[0]))
                            {
                                ...
                                if (index > 0)
                                {
                                    h = FloatTool.parseFloatWithoutException(temps[1].substring(0, index));
                                }
                                else
                                {
                                    index = temps[1].indexOf("in");
                                    if (index > 0)
                                    {
                                        h = FloatTool.parseFloatWithoutException(temps[1].substring(0, index)) * MainConstant.POINT_DPI;
                                    }
                                    else
                                    {
                                        h = FloatTool.parseFloatWithoutException(temps[1]) * zoomY * MainConstant.POINT_DPI / MainConstant.EMU_PER_INCH;
                                    }
                                }
                            }       
                        }
                    ...
                    if(autoShape instanceof WPAutoShape && ((WPAutoShape)autoShape).getShapeType() == ShapeTypes.ArbitraryPolygon)
                    {
                    	...
                    	if(coordsize != null && coordsize.length() > 0)
                    	{
                    		...
                    		float width = IntegerTool.parseIntWithoutException(size[0]);
                            float height = IntegerTool.parseIntWithoutException(size[1]);
    ...
    private float getValueInPt(String value, float zoom)
    {
        ...
        if (value.contains("pt"))
        {
            ...
            return FloatTool.parseFloatWithoutException(value.substring(0, index));
        }
        else if (value.contains("in"))
        {
            index = value.indexOf("in");
            return FloatTool.parseFloatWithoutException(value.substring(0, index)) * MainConstant.POINT_DPI;
        }
        else if(value.contains("mm"))
        {
        	index = value.indexOf("mm");
            return FloatTool.parseFloatWithoutException(value.substring(0, index)) * MainConstant.MM_TO_POINT;
        }
        else
        {
        	return FloatTool.parseFloatWithoutException(value) * zoom * MainConstant.POINT_DPI / MainConstant.EMU_PER_INCH;
        }
    }
                        ...
                        if (temps != null && temps[0] != null && temps[1] != null)
                        {
                            ...
                            else if("mso-width-percent".equalsIgnoreCase(temps[0]))
                            {
                            	if (!relativeType.contains(autoShape))
                                {
                                	...
                                	relativeVal[0] = (int)FloatTool.parseFloatWithoutException(temps[1]);
                                    relativeType.add(autoShape);
                                    relativeValue.put(autoShape, relativeVal);
                                }
                            	else
                            	{
                            		relativeValue.get(autoShape)[0] = (int)FloatTool.parseFloatWithoutException(temps[1]);
                            	}
                            ...
                            {                            	
                                ...
                                {
                                	int[] relativeVal = new int[4];
                                	relativeVal[2] = (int)FloatTool.parseFloatWithoutException(temps[1]);
                                	relativeType.add(autoShape);
                                    relativeValue.put(autoShape, relativeVal);
                                }
                                else
                                {
                                	relativeValue.get(autoShape)[2] = (int)FloatTool.parseFloatWithoutException(temps[1]);
                                }
                            }                            	
                            ...
                            else if ("rotation".equalsIgnoreCase(temps[0]))
                            {
                                if (temps[1].indexOf("fd") > 0)
                                {
                                    ...
                                    autoShape.setRotation(IntegerTool.parseIntWithoutException(temps[1]) / 60000);
                                }
                                else
                                {
                                    autoShape.setRotation(IntegerTool.parseIntWithoutException(temps[1]));
                                }
                            }
                            ...
                            {
                            	//horizontal relative position
                            	((WPAutoShape)autoShape).setHorRelativeValue(IntegerTool.parseIntWithoutException(temps[1]));
                                    ...
                                    && "mso-top-percent".equalsIgnoreCase(temps[0]))
                            {
                            	...
                            	((WPAutoShape)autoShape).setVerRelativeValue(IntegerTool.parseIntWithoutException(temps[1]));
...
//            }
    ...
    private int getAutoShapeType(Element shape)
    {
        ...
        if (shape.attribute("type") != null)
        {
            ...
            {
                val = val.substring(9);
                shapeType = IntegerTool.parseIntWithoutException(val);
            }
        }
    ...
    private float getValue(String value)
    {
        ...
        if (index > 0)
        {
            w = FloatTool.parseFloatWithoutException(value.substring(0, index));
        }
        else
        {
            index = value.indexOf("in");
            if (index > 0)
            {
                w = FloatTool.parseFloatWithoutException(value.substring(0, index)) * MainConstant.POINT_DPI;
            }
            else
            {
                w = FloatTool.parseFloatWithoutException(value) * MainConstant.POINT_DPI / MainConstant.EMU_PER_INCH;
            }
        }
        ...
        if (shape != null)
        {
            ...
            if (adjustStr != null && adjustStr.length > 0)
            {
                ...
                for (int i = 0; i < adjustStr.length; i++)
                {
                    ...
                    if (temp != null && temp.length() > 0)
                    {
                        values[i] = FloatTool.parseFloatWithoutException(temp) / 21600;
                    }
                    else
                    {
                        values[i] = null;
    ...
    {	
        ...
        if (textpath != null)
        {
        	...
        	if(fill != null)
        	{
        		waterMark.setOpacity(FloatTool.parseFloatWithoutException(fill.attributeValue("opacity")));
        	}
        	...
        	for(String item : styles)
        	{
        		...
        		{
        			int fontSize = IntegerTool.parseIntWithoutException(items[1].replace("pt", ""));
        			if(fontSize == 1)
        			{
        				//auto font size
    ...
    private Line processLine(Element shape)
    {
        ...
        if(shape.attributeValue("strokeweight") != null)
        {
            ...
            lineWidth = Math.round(FloatTool.parseFloatWithoutException(val) * MainConstant.POINT_TO_PIXEL);
        }            
		        ...
		        if(fillElem == null || type == BackgroundAndFill.FILL_SOLID)
		        {
		        	...
		        	if(fillElem !=  null)
		        	{
		        		String opacityStr = fillElem.attributeValue("opacity");
			        	 if(opacityStr != null)
			        	 {
			        		 float opacity = FloatTool.parseFloatWithoutException(opacityStr);
			        		 if(opacity > 1)
			        		 {
			        			 opacity /= 65536f;
			        		 }
	...
	private Gradient readGradient(Element shape, Element fillElem, byte type)
	{
		...
		if(sFocus != null)
		{
			focus = IntegerTool.parseIntWithoutException(sFocus.replace("%", ""));
		}
		...
		if(sAngle !=  null)
		{
			angle = IntegerTool.parseIntWithoutException(sAngle);
		}
		switch(angle)
		{
			case -90:
		...
		if(intermediateColors != null)
		{
			...
			for(int i = 0; i < length; i++)
			{
				...
				if(pos.contains("f"))
				{
					positions[i] = FloatTool.parseFloatWithoutException(pos) / 100000f;
				}
				else
				{
					positions[i] = FloatTool.parseFloatWithoutException(pos);
				}
    ...
    private void processRunAttribute(Element rPr, IAttributeSet attr)
    {
        ...
        if (szCs != null || sz != null)
        {
            ...
            if(szCs != null)
    		{
            	...
            	szSize = Math.max(szSize, FloatTool.parseFloatWithoutException(val) / 2.f);
    		}		
            if(sz != null)
            {
    ...
    private int processValue(String val, boolean isLeftRight)
    {
        ...
        if (val != null)
        {
            ...
            {
                a = (int)(IntegerTool.parseIntWithoutException(val) * MainConstant.PIXEL_DPI / MainConstant.EMU_PER_INCH * MainConstant.PIXEL_TO_TWIPS);
            }
            else
            {
                a = (int)(IntegerTool.parseIntWithoutException(val, 16) * MainConstant.PIXEL_DPI / MainConstant.EMU_PER_INCH * MainConstant.PIXEL_TO_TWIPS);
            }
        }
        return a;
    }
