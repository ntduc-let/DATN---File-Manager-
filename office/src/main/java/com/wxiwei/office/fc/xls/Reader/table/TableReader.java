...
public class TableReader
{
    ...
    public void read(IControl control, PackagePart tablePart, Sheet sheet) throws Exception
    {
        ...
        {             
            ...
            if(str != null)
            {
            	table.setTotalsRowDxfId(IntegerTool.parseIntWithoutException(str));
            }
            ...
            if(str != null)
            {
            	table.setTotalsRowBorderDxfId(IntegerTool.parseIntWithoutException(str));
            }
            ...
            if(str != null)
            {
            	table.setHeaderRowDxfId(IntegerTool.parseIntWithoutException(str));
            }
            ...
            if(str != null)
            {
            	table.setHeaderRowBorderDxfId(IntegerTool.parseIntWithoutException(str));
            }
            ...
            if(str != null)
            {
            	table.setTableBorderDxfId(IntegerTool.parseIntWithoutException(str));
            }
