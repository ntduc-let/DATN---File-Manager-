...
public class FontDetails
{
    ...
    public static FontDetails create( String fontName, Properties fontMetricsProps )
    {
        ...
        int height = IntegerTool.parseIntWithoutException(heightStr);
        ...
        for ( int i = 0; i < widthsStrArray.length; i++ )
        {
            if (charactersStrArray[i].length() != 0)
                d.addChar(charactersStrArray[i].charAt(0), IntegerTool.parseIntWithoutException(widthsStrArray[i]));
        }
        return d;
    }
