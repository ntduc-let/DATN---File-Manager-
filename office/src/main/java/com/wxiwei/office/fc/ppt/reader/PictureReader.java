                                ...
                                if (anchor != null)
                                {
                                    ...
                                    if (text != null && text.length() > 0)
                                    {
                                        ...
                                        if (values != null && values.length == 8)
                                        {
                                            ...
                                            anchorFrom.setColumn((short) IntegerTool.parseIntWithoutException(values[0]));
                                            anchorFrom.setDX((short)IntegerTool.parseIntWithoutException(values[1]));
                                            anchorFrom.setRow((short)IntegerTool.parseIntWithoutException(values[2]));
                                            anchorFrom.setDY((short)IntegerTool.parseIntWithoutException(values[3]));
                                            
                                            AnchorPoint anchorTo = new AnchorPoint();
                                            anchorTo.setColumn((short)IntegerTool.parseIntWithoutException(values[4]));
                                            anchorTo.setDX((short)IntegerTool.parseIntWithoutException(values[5]));
                                            anchorTo.setRow((short)IntegerTool.parseIntWithoutException(values[6]));
                                            anchorTo.setDY((short)IntegerTool.parseIntWithoutException(values[7]));
